...
const Portfolio = () => {
  return (
    <div className="bgimg">
      <nav>
        <ul>
          <li><a href="#home" className="logo">Surekha.</a></li>
      ...
      <div id="home" className="main">
        <div className="text">
          <h2>HEY THERE!</h2>
          <h1 style={{ margin: '5px' }}>I am <span className="Special">B.Surekha.</span></h1>
          <pre style={{ fontFamily: 'Times New Roman, Times, serif' }}>But you can call me --<span className="Special"><b>Surekha
            </b></span></pre>
          <p><b>I'm currently a student at Annmacharaya institution.</b></p>
          <br /><a href="bittu.doc" download>Download CV</a>
        </div>
        <div className="textcol">
          <img src="profilepic.jpg" alt="Guru"/>
        </div>
      </div>
      <section id="aboutme" className="aboutme">
        <h1>About Me</h1>
        <p style={{ textAlign: 'justify' }}>I'm GuruSurekha pursuing Bachelor of Technology in <span className="special">Annmacharaya institution of technology and sciences</span> in the stream of <span className="Special">&nbsp;Computer Science and Engineering.</span> I am passionate about knowing new things in the world and I am also passionate about coding. Self-motivated, highly passionate, and hardworking fresh mind looking for an opportunity to work in a challenging organization to utilize and enhance my skills and knowledge to work for the growth of the organization.</p>
        <ul>
          <li>From - Proddature, India</li>
          <li>Lives in - Nangnoorpalle, India</li>
          <li>Age - 20</li>
          <li>Gender - Female</li>
        </ul>
      </section>
        ...
        <div className="time">
          <div className="con lef">
            ...
            <div className="text-box">
              ...
              <p>I Completed my School Education at M.P.H.SCHOOL, Akumalla,Koilakuntla</p>
              <p>I got 9.0 CGPA in my School Education.</p>
          ...
          <div className="con rig">
            ...
            <div className="text-box">
              ...
              <p>I Completed my Intermediate Education at vijayawada Nalanda jr college, Nandyal.</p>
              <p>I got 7.8 CGPA in my Intermediate Education.</p>
      ...
      <footer id="contact">
        <h1><span className="special">Contact Me</span></h1>
        <address>
          <div className="add">
            <div className="contact">
              <h2><span className="special">Where to find me</span></h2><hr />
              <p>Address: 1-47,<br /> Nangnoorpalle,<br /> Proddature(M),<br /> Kdapa(D),<br /> Andhra Pradesh state.</p>
            </div>
            <div className="contact">
              <h2><span className="special">Contact me</span></h2><hr />
              <p><b>Email:</b> <a href="mailto:bsurekha596@gmail.com">bsurekha596@gmail.com</a></p>
              <p><b>Phone:</b> <a href="tel:+91 7780730913">7075658696</a></p>
            </div>
          </div>
